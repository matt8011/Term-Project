...
//    std::vector<std::string> fileChoice;
    while(true) {
        //start menu
        ...
        if(secondRound && user) {
            ...
            if (std::stoi(menuChoice) == 0) {
                std::cout << "Type whatever word(s) you want in the tree: ";
                std::cin >> userString;
                std::cout << std::endl;
            }
            ...
            if (std::stoi(menuChoice) == 1) {
                std::cout << "Type whatever word(s) you want to be searched: ";
                std::cin >> userString;
                std::cout << std::endl;
            ...
            if (std::stoi(menuChoice) == 2) {
                std::cout << "Type whatever word(s) you want to be completed: ";
                std::cin >> userString;
                std::cout << std::endl;
